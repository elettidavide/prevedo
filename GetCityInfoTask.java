...
public class GetCityInfoTask extends AsyncTask<String, String, String> {
    ...
    public GetCityInfoTask(Activity parentActivity, String url, String nome_comune) {
    ...
    protected void onPostExecute(String result) {
        ...
        try{
            ...
            if (answer != null) {
                ...
                System.out.println("JSON INFO " + result.toString());
                ...
                if(code == 200){
                    ...
                    //l'oggetto si chiama current..
                    JSONObject infoObj = jsonObject.getJSONObject("current");

                    //leggo i valori
                    String temp_c = infoObj.getString("temp_c");
                    ...
                    String view_visibility = infoObj.getString("view_visibility");
                    ...
                    System.out.println("CITY HUM " + view_hum);
